...
Tasks:   <yes — will call /djs-create-task | no>
```
...
```
/djs-create-task <app_name> <task_name>
```
...
> (`/djs-deploy-cron <app_name> <command_name>`)

Wait for the user's answer. Do not run `djs-deploy-cron` automatically.
