...
**Prerequisites:** Backups must be configured (`/djs-enable-db-backups`).
...
The backup is uploaded to Hetzner Object Storage and will appear when you run `/djs-db-restore`.
