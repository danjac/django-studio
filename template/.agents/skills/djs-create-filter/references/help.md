**/djs-create-filter [<app_name>] <filter_name>**
...
Examples:
  /djs-create-filter blog my_filter    # blog/templatetags/blog.py
  /djs-create-filter my_filter         # <package_name>/templatetags.py (root)
